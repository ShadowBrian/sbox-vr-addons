...
namespace Facepunch.Boomer
{
	public partial class VRWeapon : AnimatedEntity
	{
		...
		public void Frame()
		{
			...
			Owner.Rotation = Input.VR.Head.Rotation.Angles().WithPitch(0).WithRoll(0).ToRotation();
		...
		public void Simulate()
		{
			if (Owner != null && Owner is Player pl)
			{
				...
				if (pl.ActiveWeapon != null && pl.ActiveWeapon.Model != Model)
				{
					SetModel(pl.ActiveWeapon.Model.ResourcePath);
				}
